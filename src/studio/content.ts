...
const LABELS: Record<string, string> = {
  ...
  clear: "Legen",
  result: "Na betaling",
  confirmationEyebrow: "Bevestiging: eyebrow",
  successTitle: "Gelukt: titel",
  successTitleNamed: "Gelukt: titel met naam",
  ...
  itemsHeading: "Bestelling-overzicht",
  customerHeading: "Klantgegevens",
  emailSent: "Mailbevestiging",
  ...
  missingOrder: "Bestelling niet getoond",
  nextHeading: "Na betaling: volgende stap",
  digitalNextTitle: "Digitaal: titel",
  digitalNext: "Volgende stap digitaal",
  physicalNextTitle: "Fysiek: titel",
  physicalNext: "Volgende stap fysiek",
  ...
  embroideryDesigns: "Digitale borduurdesigns",
  sewingProduction: "Productie en naaiwerk",
  customPouches: "Maatwerk pouches",
  personalGifts: "Gepersonaliseerde cadeaus",
  name: "Naam",
